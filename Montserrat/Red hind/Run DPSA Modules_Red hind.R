...
source(paste("Red hind\\Montserrat2-LittleBay-Red hind_ControlFile.R"))
...
#       
      ...
      save.image(file=paste(ResultFolder,AssessmentName,'_Settings2.RData',sep='')) #Save settings used to produce current results
...
#   
  ...
  save(file=paste(Assessment,'/Assessment Results2.Rdata',sep=''),AssessmentResults,MonteResults)
  
  save(file=paste(Assessment,'/Raw Data.Rdata2',sep=''),GFD)
}
if (RunAssessments==F)
{
