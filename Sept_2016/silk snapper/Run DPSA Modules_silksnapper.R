...
source(paste("Silk snapper\\Montserrat2-LittleBay-Silk snapper_ControlFile.R"))
...
#           {
            ...
            Temp<- LBAR(SampleCheck$ParedData,LagLength=1,Weight=1,IncludeMPA=0,ReserveYr=NA,OutsideBoundYr=NA,Iterations=10000,
                        BootStrap=1,LifeError=0,Lc=27.5)$Output		
