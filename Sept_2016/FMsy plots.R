...
data<-read.csv("Sept_2016/results.csv")
...
fplot<-fplot+theme(legend.position=c("left"),
...
fplot<-fplot+scale_fill_discrete(name="Assessment Method",labels=c("Catch-based","Length-based"))

ggsave("Sept_2016/plots/allresults.png",fplot,dpi=400)
# fplot<-fplot + 
#   
