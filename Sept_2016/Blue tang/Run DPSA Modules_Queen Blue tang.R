...
#       }
#       
      CurrentResults<- ldply(AssessmentResults) %>% subset(Species==Fishes[f])
      ...
      write.csv(file=paste(ResultFolder,AssessmentName,'_Results_nov.csv',sep=''),CurrentResults) #Save current results
#       
