...
# Assessments<- c('CatchCurve')
 ...
 Fish$SciName<- 'L. synagris'
 
 Fish$CommName<- 'Lane Snapper'
### Life History ###
 ...
 Fish$vbk<- 0.27                     ##DO:according to Informe final   0.21625    error 0.004M and 0.06H
 
 Fish$LengthError<- 0.05
 
 Fish$Linf<- 45.49                       ##41.9M and 40.14H averaged from Norahs values (used averages = 41.02) used our equation to determine Linf for tail length (average = 25.15 and H = 24.57)
 
 Fish$t0<- -0.815
 
 Fish$WeightA <-0.029522
 ...
 Fish$MvK<-0.909451 #Ratio of M versus K
 
 Fish$MaxAge<- 12.2 #Max age is age at thich only 1% of population are left. Can also be set manually if needed
